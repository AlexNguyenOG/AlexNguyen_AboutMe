      ...
      <div className="flex h-full flex-col items-center gap-4 text-center sm:items-start sm:text-left">
        ...
        <div className="flex flex-col gap-2 text-center sm:text-left">
          ...
          <p className="text-lg font-light leading-relaxed text-zinc-100/90">
            ...
            it, I was able to build Keysol. I mess around and by the time you
            see this &quot;My get to know me&quot; website, it was made from
            cursor AI, amazing right? Currently, I&apos;m in SF with family. The
            connections here were amazing.
          </p>
        </div>
      </div>
    </div>
